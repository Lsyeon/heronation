...
public class myPageConnectingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_page_connecting);
     ...
     */
    public void Click_userModify_btn(View view){
